      ...
      <div id="projects-section" className="relative w-full z-[2] px-4 pt-0 pb-8 overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full pointer-events-none z-0 opacity-20 text-white mix-blend-screen">
          <svg viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice" className="w-full h-full" fill="none" stroke="currentColor" strokeWidth="1">
            <defs>
              <marker id="dot-mobile" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="4" markerHeight="4">
            ...
            <path d="M 200 450 L 300 350 L 500 350" markerStart="url(#dot-mobile)" strokeDasharray="5 5" />
            <path d="M 1240 450 L 1140 550 L 940 550" markerStart="url(#dot-mobile)" strokeDasharray="5 5" />
          </svg>
        </div>
        ...
        {/* 2-column project grid — image card with name + description below */}
        <div className="mb-2 relative z-10" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '12px 12px' }}>
          {PROJECTS_DATA.map((proj) => (
            ...
            >
              ...
              <div className="font-mono text-[8px] font-bold uppercase tracking-tighter text-white/80 mt-2 leading-[1.2] w-full">
                {proj.title}
